...
function createApproval({ intent, provider, ttl_seconds = 300, now = Date.now() }, env = process.env) {
...
function verifyApproval(token, { intent, provider, now = Date.now() }, env = process.env) {
